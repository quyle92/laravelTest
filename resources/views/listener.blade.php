...
<html lang="en">
  ...
  <body>
    ...
    <script type="text/javascript">
      ...
      var pusher = new Pusher('0004ac5a6265f2b52e4e', {
        encrypted: true,
        cluster: 'ap1'
      });
      ...
      channel.bind('App\\Events\\StatusLiked', function(data) {alert(JSON.stringify(data));
...
//         .listen('App\\Events\\StatusLiked', function (e){ 
